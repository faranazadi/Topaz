package com.topaz.game.entity.impl.player;
...
import com.topaz.game.content.PetHandler;
import com.topaz.game.content.PrayerHandler;
import com.topaz.game.content.QuickPrayers;
import com.topaz.game.content.Trading;
import com.topaz.game.content.PrayerHandler.PrayerData;
import com.topaz.game.content.clan.ClanChat;
...
import com.topaz.game.content.combat.FightType;
...
import com.topaz.game.content.combat.bountyhunter.BountyHunter;
...
import com.topaz.game.content.minigames.Barrows.Brother;
...
import com.topaz.game.content.skill.skillable.Skillable;
import com.topaz.game.content.skill.skillable.impl.Runecrafting.Pouch;
import com.topaz.game.content.skill.skillable.impl.Runecrafting.PouchContainer;
import com.topaz.game.content.skill.slayer.ActiveSlayerTask;
...
import com.topaz.game.model.Appearance;
import com.topaz.game.model.ChatMessage;
import com.topaz.game.model.EffectTimer;
import com.topaz.game.model.EnteredAmountAction;
import com.topaz.game.model.EnteredSyntaxAction;
import com.topaz.game.model.Flag;
import com.topaz.game.model.ForceMovement;
...
import com.topaz.game.model.PlayerInteractingOption;
import com.topaz.game.model.PlayerRelations;
import com.topaz.game.model.PlayerStatus;
import com.topaz.game.model.SecondsTimer;
import com.topaz.game.model.Skill;
import com.topaz.game.model.SkullType;
import com.topaz.game.model.areas.AreaManager;
import com.topaz.game.model.container.impl.Bank;
import com.topaz.game.model.container.impl.Equipment;
import com.topaz.game.model.container.impl.Inventory;
...
import com.topaz.game.model.movement.MovementQueue;
...
import com.topaz.game.model.teleportation.TeleportButton;
import com.topaz.game.task.TaskManager;
import com.topaz.game.task.impl.CombatPoisonEffect;
import com.topaz.game.task.impl.PlayerDeathTask;
import com.topaz.game.task.impl.RestoreSpecialAttackTask;
import com.topaz.net.PlayerSession;
import com.topaz.net.channel.ChannelEventHandler;
import com.topaz.net.packet.PacketSender;
import com.topaz.util.FrameUpdater;
import com.topaz.util.Misc;
import com.topaz.util.NpcIdentifiers;
import com.topaz.util.Stopwatch;
...
public class Player extends Mobile {
				...
				for (Skill skill : Skill.values()) {
					...
					if (current < max) {
						if (increaseStats.finished()) {
							...
							// Prayer can only be restored by praying at an altar, so this is excluded
						...
						// Should boosted stats be decreased? Decrease every 72 secs if Preserve prayer activated
						if (decreaseStats.secondsElapsed() >= (PrayerHandler.isActivated(this, PrayerHandler.PRESERVE) ? 72 : 60)) {
							...
							// Ligma: not sure why this was added?
							//if (skill != Skill.HITPOINTS && skill != Skill.PRAYER) {
	...
	public void onLogout() {
		// Notify us
		Server.getLogger().log(Level.INFO, "Deregistering player '" + getUsername() + "' on host: " + getHostAddress());
	...
	public void onLogin() {
		...
		Server.getLogger().log(Level.INFO, "Registering player '" + getUsername() + "' on host: " + getHostAddress());
		//System.out.println("Registering player '" + getUsername() + "' on host: " + getHostAddress());
		...
		getPacketSender().sendMessage("Please report any bugs you may find.");
		long totalExp = 0;
		for (Skill skill : Skill.values()) {
