package com.topaz.game.model.container.impl;
...
import com.topaz.game.model.container.ItemContainer;
import com.topaz.game.model.container.StackType;
...
public class Bank extends ItemContainer {
    ...
    public Bank refreshItems() {
        ...
        if (getPlayer().isSearchingBank()) {
            ...
            getPlayer().getPacketSender().sendString(5383, "Bank of " + GameConstants.SERVER_NAME).sendConfig(117, 0);
        }
