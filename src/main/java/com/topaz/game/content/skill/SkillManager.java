package com.topaz.game.content.skill;
...
import com.topaz.game.content.skill.skillable.impl.Mining;
import com.topaz.game.content.skill.skillable.impl.Runecrafting;
import com.topaz.game.content.skill.skillable.impl.Woodcutting;
import com.topaz.game.content.skill.skillable.impl.Mining.Rock;
import com.topaz.game.content.skill.skillable.impl.Woodcutting.Tree;
	...
	public SkillManager addExperience(Skill skill, int experience, boolean multipliers) {
		...
		if (newLevel > startingLevel) {
			...
			if (skills.maxLevel[skill.ordinal()] == getMaxAchievingLevel(skill)) {
				...
				World.sendGlobalMessage("<shad=15536940>News: " + player.getUsername()
